...
void requestAction(CountryList &list)
{
  ...
  do {
    ...
    //5 corresponds with the quit option
  } while (input != "5");
}
...
1: Display countries    2: Search for a country 3: Delete a country
4: Add New Country      5: Exit
1
...
Country Code: i4
Invalid input. Country code may only contain 2 alphabets.
